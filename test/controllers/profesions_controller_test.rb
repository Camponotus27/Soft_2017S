...
class ProfesionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create profesion" do
    assert_difference('Profesion.count') do
      post profesions_url, params: { profesion: { descripcion: @profesion.descripcion, nombre: @profesion.nombre, servicio: @profesion.servicio } }
    end
  ...
  test "should update profesion" do
    patch profesion_url(@profesion), params: { profesion: { descripcion: @profesion.descripcion, nombre: @profesion.nombre, servicio: @profesion.servicio } }
