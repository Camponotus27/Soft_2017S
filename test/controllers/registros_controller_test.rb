...
class RegistrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registro" do
    assert_difference('Registro.count') do
      post registros_url, params: { registro: { Profesional: @registro.Profesional, cliente: @registro.cliente, codigo: @registro.codigo, comuna_atencion: @registro.comuna_atencion, fecha: @registro.fecha, horario_dia: @registro.horario_dia, servicio: @registro.servicio } }
    end
  ...
  test "should update registro" do
    patch registro_url(@registro), params: { registro: { Profesional: @registro.Profesional, cliente: @registro.cliente, codigo: @registro.codigo, comuna_atencion: @registro.comuna_atencion, fecha: @registro.fecha, horario_dia: @registro.horario_dia, servicio: @registro.servicio } }
